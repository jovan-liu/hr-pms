...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body" id="content-body">
			<form role="form" action="${appName}/item/item-update" enctype="multipart/form-data" onsubmit="return check()" method="post" class="form-horizontal">
			<div aria-hidden="true" class="alert alert-danger" id="errorMsg"
					style="display: none;"></div>
				<input type="hidden" name="icon" value="${icon}" id="icon">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="必填" class="form-control"
							name="itemName" id="itemName" value="${itemName}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control"
							name="itemCode" id="itemCode" value="${itemCode}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control"
							name="itemDesc" id="itemDesc" value="${itemDesc}">
					</div>
				</div>
