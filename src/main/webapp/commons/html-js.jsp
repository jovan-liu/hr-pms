...
<script src="http://static.l99.com/js/jquery/1.8/jquery-1.8.0.min.js"></script>
<script src="${appName}/resources/jquery/jquery-ui.js"></script>
<script type="text/javascript"
	src="${appName}/resources/js/jquery.autocomplete.js"></script>
<script type="text/javascript"
	src="${appName}/resources/js/jquery.popupwindow.js"></script>
<script src="${appName}/resources/bootstrap/js/bootstrap.min.js"></script>
...
<script type="text/javascript"
	...
	charset="UTF-8"></script>
<script type="text/javascript"
	src="${appName}/resources/js/jquery.chosen.min.js" charset="UTF-8"></script>
...
<script src="${appName}/resources/js/jquery.ui.nestedSortable.js"></script>
<script src="${appName}/resources/js/jquery.ui-contextmenu.min.js"></script>
<script>
	var count = 0;
	$(".tree").click(
			function() {
				if (count % 2 == 0) {
					...
					$(this).find(".myicon").removeClass(
							"glyphicon glyphicon-chevron-down").addClass(
	...
	function searchLog(obj, type, way) {
		if (way == "1") {
			...
			$("#" + type)
					.html(
							"<img src='${appName}/resources/bootstrap/fonts/ajax-loader.gif'>");
			$("#" + type).load("${appName}/data/data-operatefromMap.action", {
				"type" : type,
				"day" : day
			}, function() {
			...
			var beginTime = $(obj).siblings(
					"input[type=text][name='beginTime']").val();
			var endTime = $(obj).siblings("input[type=text][name='endTime']")
					.val();
			$("#" + type)
					.html(
							"<img src='${appName}/resources/bootstrap/fonts/ajax-loader.gif'>");
			$("#" + type).load("${appName}/data/data-operate.action", {
				"type" : type,
				"beginTime" : beginTime,
				"endTime" : endTime
			}, function() {
