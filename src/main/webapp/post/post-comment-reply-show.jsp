...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body" id="content-body">
			<form role="form" action="${appName}/post/post-comment-reply" enctype="multipart/form-data" onsubmit="return check()" method="post" class="form-horizontal">
			<div aria-hidden="true" class="alert alert-danger" id="errorMsg"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="必填" class="form-control"
							name="postId" id="postId" readonly="readonly" value="${postId }">
					</div>
				</div>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="必填" class="form-control"
                            name="parentId" id="parentId" readonly="readonly" value="${id }">
                    </div>
                </div>
