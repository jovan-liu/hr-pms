...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<button class="btn btn-info" style="width:150px;height:40px;margin-right: 300px;" id="addButton">申请请假</button>
	...
	<script type="text/javascript">
		...
		$("#addButton").click(function(){
	 		$('#myModal').load("<%=request.getContextPath()%>/leave/leave-add-show",function(){
				$('#myModal').modal('show');
			});
	 	});
		...
		function edit() {
			$('#myModal').load(
					"<%=request.getContextPath()%>/leave/leave-edit-show",
					function() {
						$('#myModal').modal('show');
					});
		}
