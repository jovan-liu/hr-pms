...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body" id="content-body">
			<form role="form" action="${appName}/tag/tag-update" enctype="multipart/form-data" onsubmit="return check()" method="post" class="form-horizontal">
...
<script type="text/javascript">
	...
	$("document").ready(function(){
  	...
  	function check(){
  		...
  		if(name==''||name==null){
  			$("#errorMsg").addClass("alert-danger alert").html("标签名称不能为空！").show();
  			return false;
  		}
  		return true;
  	}
